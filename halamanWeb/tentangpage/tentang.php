...
<body>
    ...
    <section class="visi_misi">
        ...
        <div class="isi_visi">
            ...
            <h3>Visi</h3>
            <p>Menjadi platform terdepan dalam penyebaran informasi dan edukasi tentang kekayaan maritim Indonesia,
                mendorong kesadaran masyarakat untuk melestarikan lautan Nusantara.</p>
    ...
    <section class="cerita">
        ...
        <div class="isi_cerita">
            ...
            <div class="teks_cerita">
                <p>
                    Permata Biru Nusantara berawal dari kepedulian terhadap laut Indonesia yang kaya namun belum
                    sepenuhnya dijaga.
                    Berawal dari ide kecil di tahun 2025, kami membangun wadah digital yang dapat memperkenalkan
                    kekayaan laut Nusantara
                    sekaligus mengedukasi masyarakat akan pentingnya menjaga ekosistem laut.
                </p>
                <p>
                    Dari konsep sederhana hingga menjadi situs informasi yang memuat artikel, penelitian, dan kisah
                    inspiratif,
                    kami berupaya menghadirkan pandangan baru tentang keindahan sekaligus tantangan dunia bawah laut
                    Indonesia.
                </p>
                <p>
                    Kini Permata Biru Nusantara bukan hanya sekadar web, tetapi juga ruang kolaborasi untuk pecinta
                    laut,
